...
public class SignUpFragment extends Fragment implements View.OnClickListener {
    public static final String COMING_FROM_SIGN_UP = "COMING_FROM_SIGN_UP";
    ...
    private void createNewUser(String name, String email, String password){
        ...
        if(UserAuthenticationHelper.checkUserStatus() && getActivity() != null){
            ...
            Intent imageIntent = new Intent(getContext(), UserImageActivity.class);
            imageIntent.putExtra(COMING_FROM_SIGN_UP,true);
